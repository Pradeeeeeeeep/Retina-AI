...
This repo tracks issues as local markdown files, so a "label" is the value of the `Status:` line near the top of an issue file rather than a tracker-side label object.
