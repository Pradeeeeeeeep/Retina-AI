...
If a `CONTEXT-MAP.md` ever appears at the root, this repo has moved to multi-context: read it first, then each per-context `CONTEXT.md` relevant to the topic, and also check `src/<context>/docs/adr/` for context-scoped decisions.
